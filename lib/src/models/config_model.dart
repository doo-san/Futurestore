class ConfigModel {
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    data = json['data'] != null ? Data.fromJson(Map<String, dynamic>.from(json['data'])) : null;
  }
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    appConfig = json['app_config'] != null
        ? AppConfig.fromJson(Map<String, dynamic>.from(json['app_config']))
        : null;
    androidVersion = json['android_version'] != null
        ? AndroidVersion.fromJson(Map<String, dynamic>.from(json['android_version']))
        : null;
    iosVersion = json['ios_version'] != null
        ? IosVersion.fromJson(Map<String, dynamic>.from(json['ios_version']))
        : null;
    ...
    if (json['languages'] != null) {
      ...
      json['languages'].forEach((v) {
        languages!.add(Languages.fromJson(Map<String, dynamic>.from(v)));
      });
    }
    if (json['currencies'] != null) {
      currencies = <Currencies>[];
      json['currencies'].forEach((v) {
        currencies!.add(Currencies.fromJson(Map<String, dynamic>.from(v)));
      });
    }
    if (json['pages'] != null) {
      pages = <Pages>[];
      json['pages'].forEach((v) {
        pages!.add(Pages.fromJson(Map<String, dynamic>.from(v)));
      });
    }
    currencyConfig = json['currency_config'] != null
        ? CurrencyConfig.fromJson(Map<String, dynamic>.from(json['currency_config']))
        : null;
  }
...
class Addons {
  ...
  Addons.fromJson(Map<String, dynamic> json) {
    ...
    status = json['status'];
    image = json['image'];
    addonData = json['data'] != null ? AddonData.fromJson(Map<String, dynamic>.from(json['data'])) : null;
  }
