...
class _EditProfileState extends State<EditProfile> {
  ...
  Widget _ui() {
    return ListView(
      children: [
        ...
        LoginEditTextField(
          myController: _profileController.firstNameController,
        ...
        LoginEditTextField(
          myController: _profileController.lastNameController,
          keyboardType: TextInputType.text,
        ...
        LoginEditTextField(
          isReadonly: false,
          myController: _profileController.phoneController,
          keyboardType: TextInputType.text,
        ...
        LoginEditTextField(
           isReadonly: false,
          myController: _profileController.emailController,
          keyboardType: TextInputType.text,
  ...
  void updateProfile() {
    ...
    selectedImage != null
        ? Repository()
            .postUpdateProfile(
            firstName: _profileController.firstNameController.text,
            lastName: _profileController.lastNameController.text,
            emailAddress: _profileController.emailController.text,
            phoneNumber: _profileController.phoneController.text,
