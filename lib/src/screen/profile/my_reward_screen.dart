...
class MyRewardScreen extends StatelessWidget {
  ...
  MyRewardScreen({super.key,required this.userDataModel,this.conversionRate});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:  Obx(()=> myRewardController.myRewardModel.value.data!=null?  Container( //!Previous -> Obx(()=> myRewardController.myRewardModel.value.data!=null? 
        height: size.height,
        width: size.width,
        color: Colors.white,
        child: ListView(
      ...
      ): SizedBox(child: Center(child: Text(AppTags.noRewardAvailableYet.tr)),)),
    );
  }
  Future<dynamic> convertRewardWallet(context) {
