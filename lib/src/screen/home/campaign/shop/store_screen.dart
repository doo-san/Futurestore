...
class StoreScreen extends StatelessWidget {
  StoreScreen({super.key, this.visitShopModel});
  ...
  Column newArrival(itemIndex , context) {
    return Column(
      children: [
        Row(
  ...
  Column bestSelling(itemIndex,context) {
    return Column(
      children: [
        Row(
          mainAxisAlignment: MainAxisAlignment.start,
  ...
  Column offerEnding(itemIndex,context) {
    return Column(
      children: [
        Row(
          mainAxisAlignment: MainAxisAlignment.start,
  ...
  Column bestRatedProducts(itemIndex,context) {
    return Column(
      children: [
        Row(
          mainAxisAlignment: MainAxisAlignment.start,
  ...
  Column featuredProducts(itemIndex, context) {
    return Column(
      children: [
        Row(
          mainAxisAlignment: MainAxisAlignment.start,
