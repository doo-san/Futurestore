...
class DetailsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (productId.isNotEmpty &&
        controller.currentProductId != productId) {

      controller.getProductDetails(int.parse(productId));

    }

    return Scaffold(

      body: GetBuilder<DetailsPageController>(
        ...
        builder: (controller) {
          ...
          /// display
          return _detailsPageUI(product, context, Get.find<CurrencyConverterController>());
